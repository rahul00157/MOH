...
html { background: #080810; color: var(--pearl); overflow-x: hidden; scroll-behavior: smooth; }
body { background: #080810; font-family: var(--sans); font-weight: 300; cursor: none; }
...
const BRIEF = [
  { key: "Brand",     val: "BMW India" },
  { key: "Platform",  val: "DV360 · Programmatic" },
  { key: "Duration",  val: "6 Months · 2023" },
  { key: "Objective", val: "Brand Awareness" },
];

const STATS = [
  { num: "1.12B", label: "Impressions" },
  { num: "89%",   label: "Viewability" },
  { num: "$0.21", label: "Avg CPM" },
  { num: "6",     label: "Months" },
];
...
export default function BMWCaseStudy() {
  ...
  return (
    <>
      ...
      <section className="cs-hero">
        <img src="/bmw.png" className="cs-hero-wm" alt="" aria-hidden="true" />
        ...
        <div className="cs-hero-inner">
          ...
          <h1 className="cs-hero-title">BMW India.</h1>
          <p className="cs-hero-sub">One billion people saw what we made.</p>
        </div>
      </section>
      ...
      <section className="cs-brief">
        ...
        <p className="cs-brief-quote rv" ref={reveal}>
          Luxury doesn't shout. It makes you look.
        </p>
      </section>
      ...
      <section className="cs-challenge">
        <p className="cs-challenge-text rv" ref={reveal}>
          BMW India is already a known name. The challenge wasn't awareness — it was precision.
          Getting the ad in front of the right person, at the right moment, on the right screen.
          Not everyone is a BMW buyer. But the ones who are — they needed to see this.
        </p>
      </section>
      ...
      <section className="cs-result">
        <p className="cs-result-text rv" ref={reveal}>
          In 6 months — we delivered over a billion impressions. Not to everyone.
          To exactly the right people. The ones who notice quality. The ones who remember.
          The ones who eventually walk into a BMW showroom.
          That's not reach. That's precision at scale.
        </p>
