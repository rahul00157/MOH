...
html { background: #0a0f0a; color: var(--pearl); overflow-x: hidden; scroll-behavior: smooth; }
body { background: #0a0f0a; font-family: var(--sans); font-weight: 300; cursor: none; }
...
.cs-hero-wm {
  ...
  animation: wmFadeIn 2s ease 0.5s both;
}
.cs-hero-back {
...
@keyframes wmFadeIn { from{ opacity:0; transform:translate(-50%,-50%) scale(1.06); } to{ opacity:0.04; transform:translate(-50%,-50%) scale(1); } }
...
const BRIEF = [
  { key: "Brand",     val: "Godrej Properties" },
  { key: "Platform",  val: "Events + LinkedIn · Targeted Outreach" },
  { key: "Duration",  val: "3 Months · 2024" },
  { key: "Objective", val: "Lead Quality · Decision-Maker Acquisition" },
];

const STATS = [
  { num: "684",    label: "Qualified Leads" },
  { num: "28%",    label: "MQL Improvement" },
  { num: "$11.40", label: "Cost Per Lead" },
  { num: "3",      label: "Months" },
];
...
export default function GodrejCaseStudy() {
    ...
    <>
      ...
      <section className="cs-hero">
        ...
        <div className="cs-hero-inner">
          ...
          <h1 className="cs-hero-title">Godrej Properties.</h1>
          <p className="cs-hero-sub">684 decision-makers walked in. 28% more qualified than before.</p>
        </div>
      </section>
      ...
      <section className="cs-brief">
        ...
        <p className="cs-brief-quote rv" ref={reveal}>
          Real estate doesn&rsquo;t sell itself. Trust does.
        </p>
      </section>
      ...
      <section className="cs-challenge">
        <p className="cs-challenge-text rv" ref={reveal}>
          Godrej Properties wasn&rsquo;t struggling with brand recognition. Everyone knows Godrej.
          The challenge was different — reaching the right buyer. Not just anyone looking for a home.
          The serious ones. The decision-makers. LinkedIn was the answer. Not because it was obvious
      ...
      <section className="cs-result">
        <p className="cs-result-text rv" ref={reveal}>
          In 3 months — 684 serious buyers raised their hand. 28% more qualified than any previous
          campaign. Not mass reach. Not random clicks. The right people. At the right time.
          That&rsquo;s what LinkedIn does when you actually know how to use it.
        </p>
