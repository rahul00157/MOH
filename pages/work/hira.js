...
html { background: #0f0d08; color: var(--pearl); overflow-x: hidden; scroll-behavior: smooth; }
body { background: #0f0d08; font-family: var(--sans); font-weight: 300; cursor: none; }
...
const BRIEF = [
  { key: "Brand",     val: "Hira Sweets" },
  { key: "Platform",  val: "Meta · Facebook · Instagram" },
  { key: "Duration",  val: "6 Months" },
  { key: "Objective", val: "Local Brand Awareness · NCR" },
];

const STATS = [
  { num: "12.5L", label: "Impressions Delivered" },
  { num: "NCR",   label: "Market Covered" },
  { num: "6",     label: "Months" },
...
export default function HiraCaseStudy() {
    ...
    <>
      ...
      <section className="cs-hero">
        ...
        <div className="cs-hero-inner">
          ...
          <h1 className="cs-hero-title">Hira Sweets.</h1>
          <p className="cs-hero-sub">A local name. 12.5 lakh people noticed.</p>
        </div>
      </section>
      ...
      <section className="cs-challenge">
        <p className="cs-challenge-text rv" ref={reveal}>
          Hira Sweets wasn&rsquo;t trying to compete with the world. Just NCR. But even locally
          — getting noticed is hard. Every sweet shop has a Facebook page. Every brand is boosting
          posts. The challenge was standing out in a local market that was already crowded.
          We didn&rsquo;t boost posts. We built a strategy.
        </p>
      </section>
      ...
      <section className="cs-result">
        <p className="cs-result-text rv" ref={reveal}>
          12.5 lakh impressions. Across the NCR market. For a local brand — that&rsquo;s not a
          small number. That&rsquo;s market presence. People saw Hira Sweets on their feed,
          in their stories, between their reels. And they remembered.
          That&rsquo;s what local marketing is supposed to feel like.
        </p>
